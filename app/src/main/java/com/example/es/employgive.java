...
public class employgive extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spinner = findViewById(R.id.spincats);
        ...
        wn=(EditText)findViewById(R.id.workernos);
        ad =(EditText)findViewById(R.id.workplaces);
        ph = (EditText)findViewById(R.id.ownerphones);
    ...
    public void empsub(View v) {
        ...
        myref123=database.getReference().child("Accounts");
